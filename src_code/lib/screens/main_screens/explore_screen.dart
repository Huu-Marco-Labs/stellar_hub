        ...
        headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
          return <Widget>[
            const SliverAppBarWidget(
                title: 'EXPLORE', subTitle: 'The Universe'),
          ];
        },
        body: Padding(
          ...
          child: Column(
            children: [
                      ...
                      return Obx(
                        () => GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            child: Padding(
                              padding:
                                  EdgeInsets.fromLTRB(16.0.w, 0.h, 16.0.w, 0.h),
                              child: Center(
                                child: Text(
              ...
              const ViewAllHeaderWidget(title: 'On- Going Missions'),
              ColoredListWidget(images: images9, height: 145.h),
              SizedBox(height: kSizedBox),
              const ViewAllHeaderWidget(title: 'Alphabetically'),
              exploreGridWidget(),
              SizedBox(height: kSizedBox),
              const ViewAllHeaderWidget(title: 'Schedule'),
              Column(
